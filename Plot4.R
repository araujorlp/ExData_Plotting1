...
household_power_consumption_ss$Voltage <- as.numeric(household_power_consumption_ss$Voltage)
household_power_consumption_ss$Global_reactive_power <- as.numeric(household_power_consumption_ss$Global_reactive_power)
...
with(household_power_consumption_ss, plot(Date_Time, Voltage, type = "l", ylab = "Voltage", xlab = "datetime"))
...
with(household_power_consumption_ss, plot(Date_Time, Global_reactive_power, type = "l", ylab = "Global_reactive_power", xlab = "datetime"))
